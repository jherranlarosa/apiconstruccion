...
<div class="email-ontainer">
        ...
        <div class="body-email" style="font-family: Roboto; color: #7A7878; padding: 15px;">
                ...
                <h5 style="color: #444141; margin-bottom: 5px;">{{$dato->fechaCreacion}} (GMT-0)</h5>
                <h3 style="color: #444141; margin: 0px;">NOC TIWS</h3>
                <br>
    
    
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">Ha transcurrido 30 min sin revisar el ticket que ha sido designado al NOC.</p>
    
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">Ingrese a Bifrost y registre el primer avance sobre la averia del ticket {{$dato->numticket}}</p>

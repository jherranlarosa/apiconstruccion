...
<div class="email-ontainer">
        ...
        <div class="body-email" style="font-family: Roboto; color: #7A7878; padding: 15px;">
                ...
                <h3 style="color: #444141; margin: 0px;">Estimado NOC TIWS,</h3>
                <br>
    
    
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">Tenga en cuenta que el ticket ha cambiado de estado a EN CURSO.</p>
    
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">El cliente  ha compartido información. Ingrese a Bifrost para continuar brindándole  soporte al problema reportado.</p>

...
<div class="email-ontainer">
        ...
        <div class="body-email" style="font-family: Roboto; color: #7A7878; padding: 15px;">
                ...
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">Ha transcurrido 01 Hora sin actualizacion de la averia masiva TT {{$dato->numticket}}</p>
    
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">Ingrese a Bifrost y actualize sobre la averia masiva del TT {{$dato->numticket}}</p>

...
<div class="email-ontainer">
        ...
        <div class="head-email" style="padding: 20px; font-family: Roboto; width: 100%; display: flex; align-items: center; justify-content: center; background-color: #354B62;">
            ...
            <div class="head-email__info" style="float:left; width:60%; overflow:hidden; text-align: right; padding-right: 8%;">
                <h3 style="margin: 0px; color: white;">Solicitud de Información</h3>
                <h3 style="margin: 0px; color: white;">Ticket 000XXX</h3>
            </div>
        </div>    
        ...
        <div class="body-email" style="font-family: Roboto; color: #7A7878; padding: 15px;">
                ...
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">Se le recuerda que tiene pendiente el envio de informacion solicitada por el NOC TIWS para continuar brindandole soporte al problema reportado..</p>
    
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">Para mayor detalle ingrese al portal Bifrost y consulte este numero de ticket.</p>

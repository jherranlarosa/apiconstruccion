...
<div class="email-ontainer">
        ...
        <div class="body-email" style="font-family: Roboto; color: #7A7878; padding: 15px;">
                ...
                <h5 style="color: #444141; margin-bottom: 5px;">{{$dato->fechaCreacion}}</h5>
                <h3 style="color: #444141; margin: 0px;">NOC TIWS</h3>
                <br>
    
    
                <p style="line-height: 1.5rem; margin-bottom: 15px; font-size: 14px;">Ha transcurrido 02 horas sin actualizacion del TT {{$dato->numticket}}</p>
